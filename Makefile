...
cflags := -Isrc/brogue -Isrc/platform -Isrc/variants -Isrc/mcp -std=c99 \
...
sources := $(wildcard src/brogue/*.c) $(wildcard src/variants/*.c) $(wildcard src/mcp/*.c) $(addprefix src/platform/,main.c platformdependent.c null-platform.c)
objects :=
